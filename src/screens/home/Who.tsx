      ...
      <div className="relative isolate px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-4xl py-32 sm:py-48 lg:py-56">
          ...
          <div className="mt-12 sm:mt-24 flex justify-center flex-wrap gap-2 sm:mx-28 lg:mx-32 md:gap-4 lg:gap-4">
            <Skill logo={SVGS.react} />
            <Skill logo={SVGS.figma} />
            <Skill logo={SVGS.typescript} />
            <Skill logo={SVGS.react} title="Native" />
            <Skill logo={SVGS.javascript} />
            <Skill logo={SVGS.tailwind} />
            <Skill logo={SVGS.git} />
            <Skill logo={SVGS.salesforce} />
            <Skill logo={SVGS.nodejs} />
            <Skill logo={SVGS.redux} />
            <Skill logo={SVGS.kubernetes} />
            <Skill logo={SVGS.unity} />
            <Skill logo={SVGS.flutter} />
            <Skill logo={SVGS.next} />
            <Skill logo={SVGS.azure} />
          </div>
        </div>
