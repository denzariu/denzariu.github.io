  ...
  return (
    ...
    {/* <div className='mt-8 mx-auto'>
      <div className='flex -space-x-2'>
        ...
        {/* BG */}
        <div
          className="absolute inset-x-0 -mx-16 top-[calc(100%-28rem)] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-[calc(100%-40rem)] pointer-events-none"
          aria-hidden="true"
        >
          <div
            className="relative translate-y-[3rem] aspect-[1200/678] w-[36.125rem] sm:translate-x-[32rem] sm:translate-y-[8rem] lg:translate-y-[12rem] bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-60 sm:right-[calc(38%+4rem)] sm:w-[72.1875rem]"
            style={{
              clipPath:
